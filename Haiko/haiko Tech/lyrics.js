...
const text = m.body.slice(prefix.length + cmd.length).trim();
  ...
  if (validCommands.includes(cmd)) {
    ...
    try {
      await m.React('🕘');
      await m.reply('A moment, *🚀 HAIKO-MDX-V2* is generating your lyrics request...');
      ...
      if (result && result.lyrics) {
        ...
        let buttons = [{
          ...
          },
          {
            name: "cta_url",
            buttonParamsJson: JSON.stringify({
              display_text: "MYSTIC HAIKO TECH CHANNEL",
              url: `https://whatsapp.com/channel/0029VbADTgbGzzKPWZ5MC52T`
            })
          },
          {
            name: "quick_reply",
