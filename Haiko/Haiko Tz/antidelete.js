...
export const handleAntidelete = async (m, sock, isBotAdmins) => {
    ...
    if (cmd === 'antidelete') {
        ...
        if (action === 'set') {
            ...
            return await sock.sendMessage(m.from, {
                text: `━⚡ *haiko mdx AntiDelete mode set to:* ${mode.toUpperCase()} ⚡━`,
                contextInfo: {
                    forwardingScore: 5,
                    isForwarded: true,
                    forwardedNewsletterMessageInfo: {
